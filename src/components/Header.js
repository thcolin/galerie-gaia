              ...
              <>
                <nav id='main-navigation' className='site-navigation' aria-label='Main Navigation'>
                  <div className='site-nav-inside'>
                    ...
                    <ul className='menu'>
                      {_.map(_.get(this.props, 'pageContext.menus.main'), (item, index) => (
                        <li key={index} className={'menu-item ' + ((_.get(this.props, 'pageContext.url') === _.get(item, 'url')) ? ' current-menu-item' : '')}>
