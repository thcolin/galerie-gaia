...
biography: "# Déco arty à petit prix\n\nDes éditions limitées à petit prix,  \nchinées
  ...
  vous !"
works:
- title: " 1 trait par Cindy Belaud"
  ...
  dimensions:
    ...
    depth: 0
  description: |-
    # Cindy Belaud - sérigraphe

    Titre de la sérigraphie "1 trait bleu puis un autre orange à nouveau 1 t vert puis 1 rouge 1 trait encore jaune et 1 autre rose toujours"
